  ...
  return (
    ...
    <div className='flex flex-col items-center py-6'>
      ...
      <div className="mb-6">
        ...
        <input type="password" placeholder="Confirm Password" className="w-full px-6 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#9C8679] focus:border-transparent duration-200"/>
      </div>
