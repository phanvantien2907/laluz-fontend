    ...
    <div className="container py-8 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <Card className="md:w-1/3 h-fit">
          ...
          <CardContent>
            <div className="flex flex-col space-y-3">
              ...
              <Link href="/profile/change-password" className="text-gray-700 hover:text-[#9C8679] transition-colors py-2 px-4 rounded-lg hover:bg-[#9C8679]/10">
                Thay đổi mật khẩu
              </Link>
              ...
              <FaSignOutAlt className="mr-2" /> Đăng xuất</span>
        ...
        <Card className="md:w-2/3">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-[#9C8679]">Thông tin cá nhân</CardTitle>
          </CardHeader>
          <CardContent>
            <form className="space-y-5">
              <div className="grid gap-5">
                <div className="space-y-2">
                  <Label htmlFor="fullname" className="font-bold hover:cursor-pointer">Họ và tên</Label>
                  <Input  id="fullname"  placeholder="Nhập họ và tên của bạn"  className="rounded-full px-6 focus:ring-2 focus:ring-[#9C8679] hover:cursor-pointer"/>
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="font-bold hover:cursor-pointer">Email</Label>
                  <Input id="email" type="email" placeholder="example@example.com"  className="rounded-full px-6 focus:ring-2 focus:ring-[#9C8679] hover:cursor-pointer"/>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="phone" className="font-bold hover:cursor-pointer">Số điện thoại</Label>
                  <Input id="phone" type="tel" placeholder="Nhập số điện thoại" className="rounded-full px-6 focus:ring-2 focus:ring-[#9C8679] hover:cursor-pointer"/>
                </div>
              </div>

              <Button type="submit" className="group relative bg-[#9C8679] hover:bg-[#8B7868] text-white w-full md:w-auto block rounded-xl px-8 overflow-hidden transition duration-300">
              <span className="relative z-10 group-hover:text-[#9C8679] transition-colors duration-300">THAY ĐỔI</span>
              <span className="absolute inset-x-0 bottom-0 h-0 bg-white group-hover:h-full transition-all duration-300 ease-out z-0"></span>
            </Button>
