...
const NuocHoaUniSexSection:React.FC<SectionProps> = ({products}) => {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
  ...
  return (
    <>
       ...
       initial={{ opacity: 0, y: -100 }}  
        ...
        <h5 className='text-bold font-bold text-3xl text-center uppercase mt-12 hover:text-[#9C8679] duration-200'>Nước hoa unisex</h5>
      </motion.div>
...
export default NuocHoaUniSexSection
