...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await axios.post(`${process.env.NEXT_PUBLIC_SERVER_API}/api/contact`, fromData);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="w-full md:w-1/2  p-6 rounded-lg shadow-sm" >
            ...
            <div className="mb-4">
              <label className="block mb-2 pl-2 text-sm font-bold text-gray-700">
            ...
            <div>
              <button type='submit' className="group relative w-full py-3 text-white bg-[#9C8679] rounded-3xl uppercase hover:text-[#9C8679] overflow-hidden transition duration-300 border border-[#9C8679]">
            ...
            <div className="h-full">
              <div className="rounded-lg overflow-hidden shadow-md border border-gray-200 h-[calc(100%-40px)]">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.284519669414!2d105.85021631476256!3d21.01336699367772!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135abf2b8c3c1e5%3A0x4e3c6d2f7c7b4c3!2zQ-G7rWEgSMOgIFRo4bq_LCBQaMO6LCBIYWkgQsOsbmggVHLGsOG7nW5n!5e0!3m2!1svi!2s!4v1631085761967!5m2!1svi!2s"
